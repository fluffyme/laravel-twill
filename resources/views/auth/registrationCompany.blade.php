        ...
        <div class="registratios__container">
            <div class="form-contacts__container">
                <div class="form-contacts__body">
                    <form action="{{route('register.company')}}" class="form__form contact-form" id="registerForm">
                        @csrf
                        <h3 class="contact-form__name">РЕГИСТРАЦИЯ</h3>
                        <h4 class="contact-form__subname">КОМПАНИЯ</h4>
                        <div class="contact-form__row">
                            <div class="contact-form__column">
                                <div class="contact-form__line">
                                    <input class="contact-form__input" type="text" name="trademark" placeholder="Торговая марка" required>
                                </div>
                                <div class="contact-form__line">
                            ...
                            <div class="contact-form__column">
                                <div class="contact-form__line">
                                    <input class="contact-form__input" type="text" name="legal_name" placeholder="Юридическое название" required>
                                </div>
                                <div class="contact-form__line">
